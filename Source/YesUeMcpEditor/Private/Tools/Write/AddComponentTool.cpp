	...
	const FMcpToolContext& Context)
{
	...
	UE_LOG(LogYesUeMcp, Log, TEXT("add-component: %s to %s"), *ComponentClass, *ActorName);
	...
	UE_LOG(LogYesUeMcp, Log, TEXT("add-component: Added %s to %s"), *NewComponent->GetName(), *FoundActor->GetName());
