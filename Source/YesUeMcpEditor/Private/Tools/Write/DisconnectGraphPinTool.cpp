	...
	const FMcpToolContext& Context)
{
	...
	UE_LOG(LogYesUeMcp, Log, TEXT("disconnect-graph-pin: %s.%s in %s"), *NodeId, *PinName, *AssetPath);
	...
	if (UBlueprint* Blueprint = Cast<UBlueprint>(Object))
	{
		...
		UE_LOG(LogYesUeMcp, Log, TEXT("disconnect-graph-pin: Broke %d connections"), ConnectionsCount);
	...
	if (UMaterial* Material = Cast<UMaterial>(Object))
	{
		...
		UE_LOG(LogYesUeMcp, Log, TEXT("disconnect-graph-pin: Disconnected material input"));
