	...
	const FMcpToolContext& Context)
{
	...
	UE_LOG(LogYesUeMcp, Log, TEXT("connect-graph-pins: %s.%s -> %s.%s in %s"),
	...
	if (UBlueprint* Blueprint = Cast<UBlueprint>(Object))
	{
		...
		if (bConnected)
		{
			...
			UE_LOG(LogYesUeMcp, Log, TEXT("connect-graph-pins: Successfully connected pins"));
		}
		else
		{
	...
	if (UMaterial* Material = Cast<UMaterial>(Object))
	{
		...
		UE_LOG(LogYesUeMcp, Log, TEXT("connect-graph-pins: Connected material expressions"));
