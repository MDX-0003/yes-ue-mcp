	...
	const FMcpToolContext& Context)
{
	...
	UE_LOG(LogYesUeMcp, Log, TEXT("remove-graph-node: %s from %s"), *NodeId, *AssetPath);
	...
	if (UBlueprint* Blueprint = Cast<UBlueprint>(Object))
	{
		...
		UE_LOG(LogYesUeMcp, Log, TEXT("remove-graph-node: Removed Blueprint node %s"), *NodeId);
	...
	if (UMaterial* Material = Cast<UMaterial>(Object))
	{
		...
		UE_LOG(LogYesUeMcp, Log, TEXT("remove-graph-node: Removed material expression %s"), *NodeId);
