...
TMap<FString, FMcpSchemaProperty> UGetLogsTool::GetInputSchema() const
{
	...
	Category.Description = TEXT("Filter by log category (e.g., 'LogYesUeMcp', 'LogTemp', or '*' for all). Supports wildcards.");
	...
	const FMcpToolContext& Context)
{
	...
	UE_LOG(LogYesUeMcp, Log, TEXT("get-logs: category='%s', severity='%s', limit=%d, search='%s'"),
