	...
	const FMcpToolContext& Context)
{
	...
	UE_LOG(LogYesUeMcp, Log, TEXT("build-and-relaunch: Starting build and relaunch workflow (Config: %s, SkipRelaunch: %s)"),
	...
	UE_LOG(LogYesUeMcp, Log, TEXT("build-and-relaunch: Batch script launched successfully (PID: %d). Requesting editor shutdown..."), CurrentPID);
